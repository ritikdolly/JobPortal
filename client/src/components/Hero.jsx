        ...
        <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
            ...
            <div className='flex items-center justify-between bg-white text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
                <div className='flex items-center'>
                    ...
                    <input type="text" className='max-sm:text-xs p-2 rounded outline-none w-full' name="search" id="search" placeholder='Search for jobs'/>
                </div>
                <div className='flex items-center'>
                    <img className='h-4 sm:h-5' src={assets.location_icon} alt="location"/>
                    <input type="text" className='max-sm:text-xs p-2 rounded outline-none w-full' name="search" id="search" placeholder='Location'/>
                </div>
